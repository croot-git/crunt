        ...
        $.fn.smartZoom = function(method) {
            ...
            var publicMethods = {
                ...
                init: function(options) {
                    ...
                    clearTimeout(doit);
                    doit = setTimeout(adjustToContainer, 1000);
            ...
            function adjustToContainer() {
                ...
                var containerDivNewLeft = getContainerDivPositionFromSettings(smartData.settings.left, parentOffset.left, containerDiv.parent().css("width"));
                var containerDivNewTop = getContainerDivPositionFromSettings(smartData.settings.top, parentOffset.top, containerDiv.parent().css("height"));

                containerDiv.offset({
                    left: containerDivNewLeft,
                    top: containerDivNewTop
                }); // apply position find
                var w = containerDiv.parent().css("width") < getContainerDivSizeFromSettings(smartData.settings.width, containerDiv.parent().css("width"), containerDivNewLeft - parentOffset.left);
                w = true ? containerDiv.parent().css("width") : getContainerDivSizeFromSettings(smartData.settings.width, containerDiv.parent().css("width"), containerDivNewLeft - parentOffset.left);
                //alert(w);
                var h = containerDiv.parent().css("height") < getContainerDivSizeFromSettings(smartData.settings.height, containerDiv.parent().css("height"), containerDivNewTop - parentOffset.top);
                h = true ? containerDiv.parent().css("height") : getContainerDivSizeFromSettings(smartData.settings.height, containerDiv.parent().css("height"), containerDivNewTop - parentOffset.top);

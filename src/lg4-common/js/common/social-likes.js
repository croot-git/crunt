...
(function(factory) { // Try to register as an anonymous AMD module
    ...
    $.fn.socialLikes.defaults = {
        ...
        //shorturl : window.location.href.replace(window.location.hash, ''),
    ...
    Button.prototype = {
        ...
        initHtml: function() {
            ...
            // accessibility
            var tit = $('.share_box').data('title-new-window');
            if (!tit) tit = "Open the new window";
